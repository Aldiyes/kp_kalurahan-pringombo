...
export const EditPendidikanSdt = ({ initialData, nik }: Props) => {
  ...
  return (
    <div className="mt-6 border bg-slate-100 rounded-md p-4">
      ...
      {!isEditing && <div className={cn("text-sm mt-2", !initialData.pendidikan_sdt && "text-slate-500 italic")}>{!initialData.pendidikan_sdt ? "Tidak diketahui" : initialData.pendidikan_sdt}</div>}
      {isEditing && (
        <Form {...form}>
